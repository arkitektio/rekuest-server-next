...
TEMPLATES = [
    {
        "BACKEND": "django.implementation.backends.django.DjangoImplementations",
        "DIRS": [],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                "django.implementation.context_processors.debug",
                "django.implementation.context_processors.request",
