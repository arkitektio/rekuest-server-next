...
app_one = DemoApp(
    ...
    definitions={
        ...
        "is_bigger": models.DefinitionInputModel(
            ...
            returns=[
                models.PortInputModel(
                    ...
                    scope="GLOBAL",
                    kind="BOOL",
                    description="If a is bigger than b",
                    nullable=False,
                    effects=[],
                )
            ],
        ...
        "add": models.DefinitionInputModel(
            ...
            returns=[
                models.PortInputModel(
                    key="bigger", scope="GLOBAL", kind="INT", nullable=False, effects=[]
                )
            ],
            port_groups=[models.PortGroupInputModel(key="default", hidden=False)],
        ),
        ...
        "acquire_image": models.DefinitionInputModel(
            ...
            args=[
                models.PortInputModel(
                    ...
                    scope="GLOBAL",
                    kind="INT",
                    description="The size of z slices",
                    nullable=True,
                    effects=[],
                    default=70,
                )
            ...
            returns=[
                models.PortInputModel(
                    ...
                    description="The acquired image",
                    nullable=False,
                    effects=[],
                )
            ],
        ...
        "segment_cells": models.DefinitionInputModel(
            ...
            args=[
                ...
                models.PortInputModel(
                    ...
                    scope="GLOBAL",
                    kind="STRING",
                    description="Which label should we assign?",
                    nullable=True,
                    effects=[],
                    default="cell",
                ),
        ...
        "mark_clusters": models.DefinitionInputModel(
            ...
            returns=[
                models.PortInputModel(
                    ...
                    scope="GLOBAL",
                    kind="LIST",
                    child=models.ChildPortInputModel(
                        kind="STRUCTURE",
        ...
        "labels_exceed": models.DefinitionInputModel(
            ...
            args=[
                models.PortInputModel(
                    ...
                    identifier="@mikro/image",
                    effects=[],
                    description="The labeled image to inspect",
                ),
                models.PortInputModel(
                    key="threshold",
                    scope="GLOBAL",
                    ...
                    effects=[],
                    default=70,
                    description="The threshold of labels that the image needs",
                ),
                models.PortInputModel(
                    key="label_to_test",
                    scope="GLOBAL",
            ...
            returns=[
                models.PortInputModel(
                    key="is_bigger",
                    description="If the amount is exceeded",
                    scope="GLOBAL",
                    kind="BOOL",
                    nullable=False,
                    effects=[],
