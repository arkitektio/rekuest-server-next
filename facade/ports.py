...
class PersistBackend(Protocol):
    ...
    async def on_caller_cancel(self, agent_id: int, message: messages.CancelRequest, *, connection_id: str | None = ..., session_id: str | None = ...) -> "models.Assignation": ...
    async def on_caller_interrupt(self, agent_id: int, message: messages.InterruptRequest, *, connection_id: str | None = ..., session_id: str | None = ...) -> "models.Assignation": ...
    async def on_caller_pause(self, agent_id: int, message: messages.PauseRequest, *, connection_id: str | None = ..., session_id: str | None = ...) -> "models.Assignation": ...
    async def on_caller_resume(self, agent_id: int, message: messages.ResumeRequest, *, connection_id: str | None = ..., session_id: str | None = ...) -> "models.Assignation": ...
