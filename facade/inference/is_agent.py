...
def is_agent(definition: DefinitionInputModel, organization) -> Protocol | None:
    ...
    if definition.args[0].identifier == "@lok/room":
        x, _ = Protocol.objects.update_or_create(name="agent", organization=organization, defaults=dict(description="Is this a agent?"))
        return x
