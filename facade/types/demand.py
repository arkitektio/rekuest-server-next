...
class ActionDemandModel(BaseModel):
    ...
    arg_matches: Optional[list[rmodels.PortMatchModel]] = Field(
        default=None,
        description="The demands for the action args and returns. This is used to identify the demand in the system.",
    )
    return_matches: Optional[list[rmodels.PortMatchModel]] = Field(
        default=None,
        description="The demands for the action args and returns. This is used to identify the demand in the system.",
    )
...
class StateDemandModel(BaseModel):
    ...
    matches: Optional[list[rmodels.PortMatchModel]] = Field(
        default=None,
        description="The demands for the action args and returns. This is used to identify the demand in the system.",
    )
    protocols: Optional[list[str]] = Field(
