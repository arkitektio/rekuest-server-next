# Generated by Django 5.2 on 2025-10-02 13:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action_hash', models.CharField(blank=True, help_text='The initial hash of the Action', max_length=1000, null=True)),
                ('key', models.CharField(help_text='A reference for this dependency', max_length=2000)),
                ('protocols', models.JSONField(default=list, help_text='The protocols this dependency needs to match')),
                ...
                ('arg_matches', models.JSONField(blank=True, default=list, help_text='The binds for this dependency (Determines which implementations can be used for this dependency)', null=True)),
                ('return_matches', models.JSONField(blank=True, default=list, help_text='The binds for this dependency (Determines which implementations can be used for this dependency)', null=True)),
        ...
        migrations.AddConstraint(
            model_name='action',
            constraint=models.UniqueConstraint(fields=('organization', 'hash'), name='No multiple Actions with same hash in the same organization allowed'),
        ),
        migrations.AddConstraint(
            model_name='registry',
