    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "latest_event",
                    django_choices_field.fields.TextChoicesField(choices=[("DISCONNECT", "Disconnect (Agent disconnected)"), ("CONNECT", "Connect (Agent connected)")], choices_enum=facade.enums.AgentEventChoices, default="DISCONNECT", help_text="The Status of this Agent", max_length=1000),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    django_choices_field.fields.TextChoicesField(
                        choices=[
                            ...
                            ("PROGRESS", "Progress (Agent is making progress on the Assignation)"),
                            ("CANCELING", "Unassign (Assignation was unassigned from an Agent)"),
                            ("CANCELLED", "Unassign (Assignation was unassigned from an Agent)"),
                            ("INTERUPTING", "Interupting (Assignation was interupted)"),
                            ("INTERUPTED", "Interupted (Assignation was interupted)"),
                            ("DELEGATE", "Delegate (Assignation was delegated to another Assignation)"),
                            ("ERROR", "Error"),
                            ("CRITICAL", "Critical"),
                ...
                (
                    ...
                    django_choices_field.fields.TextChoicesField(
                        ...
                        choices_enum=facade.enums.TaskInstructChoices,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auto_resolvable",
                    models.BooleanField(default=True, help_text="If this dependency is auto resolvable, the system will try to automatically bind any agent that the user can assign to this dependency. If False, the user will have to manually bind an agent to this dependency before it can be used."),
                ),
                ...
                (
                    "assign_policy",
                    models.CharField(
                        choices=[(facade.enums.AssignPolicy["AUTOMATIC"], "AUTOMATIC"), (facade.enums.AssignPolicy["ROUND_ROBIN"], "ROUND_ROBIN"), (facade.enums.AssignPolicy["LEAST_BUSY"], "LEAST_BUSY"), (facade.enums.AssignPolicy["FASTEST_RESPONSE"], "FASTEST_RESPONSE")],
                        default=facade.enums.AssignPolicy["AUTOMATIC"],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    django_choices_field.fields.TextChoicesField(
                        choices=[
                            ("RANDOM", "Random (Assignation is assigned to a random Provision)"),
                            ("ROUND_ROBIN", "Round Robin (Assignation is assigned to the next Provision)"),
                            ("LEAST_BUSY", "Least Busy (Assignation is assigned to the least busy Provision)"),
                            ("LEAST_TIME", "Least Time (Assignation is assigned to the Provision with the least time left)"),
                            ("LEAST_LOAD", "Least Load (Assignation is assigned to the Provision with the least load)"),
                            ("DIRECT", "Direct (Assignation is assigned to a direct Provision)"),
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "latest_event",
                    django_choices_field.fields.TextChoicesField(
                        choices=[("ACTIVE", "Active"), ("KICKED", "Just kicked"), ("DISCONNECTED", "Disconnected"), ("VANILLA", "Complete Vanilla Scenario after a forced restart of")],
