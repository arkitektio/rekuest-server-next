# Generated by Django 5.2 on 2026-03-19 19:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('acted_on', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=1000), default=list, help_text='Which structures were acted on in this assignation', size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.ForeignKey(help_text='The action that has this dependency', on_delete=django.db.models.deletion.CASCADE, related_name='dependencies', to='facade.action')),
            ],
        ),
        migrations.CreateModel(
