    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', django_choices_field.fields.TextChoicesField(blank=True, choices=[('DEBUG', 'DEBUG Level'), ('INFO', 'INFO Level'), ('ERROR', 'ERROR Level'), ('WARN', 'WARN Level'), ('CRITICAL', 'CRITICAL Level')], choices_enum=facade.enums.LogLevelChoices, help_text='The event level', max_length=1000, null=True)),
        ...
        migrations.AddConstraint(
            model_name='state',
            constraint=models.UniqueConstraint(fields=('state_schema', 'agent'), name='No multiple States for same Agent and Schema allowed'),
        ),
        migrations.AddConstraint(
            model_name='testcase',
